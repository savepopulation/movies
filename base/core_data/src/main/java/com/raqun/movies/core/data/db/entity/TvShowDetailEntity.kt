...
class TvShowDetailEntity constructor(
    ...
    @ColumnInfo(name = Db.TABLES.TVSHOW_DETAILS.COLUMNS.CREATE_DATE) val createDate: Long,
    @ColumnInfo(name = Db.TABLES.TVSHOW_DETAILS.COLUMNS.UPDATE_DATE) val updateDate: Long
) : DbEntity